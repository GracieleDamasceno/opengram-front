...
export default class Profile extends React.Component {
  render() {
    const randomCoverPhoto = Session.get("randomCoverPhoto");
    let coverPhoto;
    if (randomCoverPhoto) {
      coverPhoto = <img src="https://images.unsplash.com/photo-1522075469751-3a6694fb2f61?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=80" alt="..." width="130" className="rounded mb-2 img-thumbnail"></img>
    } else {
      coverPhoto = <img alt="..." width="130" className="rounded mb-2 img-thumbnail"></img>
    }
